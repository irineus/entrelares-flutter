...
-- ============================================================================
-- BASELINE APPENDIX — objects outside the public schema that `supabase db
-- dump` does NOT capture, appended manually (T-29). Without this, a fresh
-- environment would silently break self-service sign-up (F-15).
-- ============================================================================
