...
| **4b** | flutter | **A memória, parte de julgamento**: triagem do `CLAUDE.md` do app (invariantes de produto vêm; *gotchas* do Blazor ficam), a frase do modelo de esforço que virou falsa, e as contradições dentro do texto do roadmap em `backlog/README.md`, que ainda descreve o `entrelares-app` como o repo do produto |
